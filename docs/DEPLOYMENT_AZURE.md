...
| Resource group | `<resource-group>` (North Europe) |
| Plan | `<plan>`, B1, **West Europe** (shared with UrbanExplorer, no extra cost) |
| Web App | `<app>` |
| URL | https://<app>.azurewebsites.net |
| Remove | `az webapp delete -g <resource-group> -n <app>` |
